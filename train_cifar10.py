...
parser.add_argument('--data', type=str, default='./data_cifar10/')
...
def adjust_learning_rate(optimizer, epoch):
    ...
    lr = 0.05 * (1+math.cos(float(epoch)/100*math.pi))
...
def train(epoch):
    ...
    print('Epoch %d total time: %.2f sec' % (epoch, epoch_total_time))
