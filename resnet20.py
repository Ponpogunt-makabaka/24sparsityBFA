import adder  # Original adder module (commented out)
...
# Original adder2d implementation (commented out for optimization)
def conv3x3(in_planes, out_planes, stride=1):
    return adder.adder2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, bias=False)


# def conv3x3(in_planes, out_planes, stride=1, N=2, M=8):
#     return SparseConv(in_planes, out_planes, kernel_size=3, stride=stride,padding=1, bias=False, N=N, M=M)
