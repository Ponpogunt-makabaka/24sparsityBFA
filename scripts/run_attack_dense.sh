#!/bin/bash
# BFA Attack script for Dense ResNet-20

MODEL_PATH="./models/dense_model.pth"
DATA_DIR="./data"
RESULT_DIR="./results"
MAX_FLIPS=10000
BITS_PER_ROUND=100
...
echo "======================================"
echo "BFA Attack on Dense ResNet-20"
echo "======================================"
...
# Load model
model = create_resnet20(sparsity_type=None, pretrained_path='$MODEL_PATH')
model.eval()
...
result = run_bfa_attack(
    ...
    save_path='$RESULT_DIR/attack_dense_result.pkl'
)
...
echo "Results saved to: $RESULT_DIR/attack_dense_result.pkl"
