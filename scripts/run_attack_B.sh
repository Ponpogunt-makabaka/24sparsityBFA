#!/bin/bash
# BFA Attack script for Sparse ResNet-20 (Mode B: Static Masking)
...
echo "======================================"
echo "BFA Attack on Sparse ResNet-20 (Mode B: Static)"
echo "======================================"
...
echo "Mode:         Static (Mask frozen before attack)"
echo "======================================"
...
# Freeze masks for Mode B
model.freeze_sparse_masks()
print('[BFA] Masks frozen - Mode B (Static Masking)')
...
result = run_bfa_attack(
    ...
    save_path='$RESULT_DIR/attack_sparse_B_result.pkl'
)
...
echo "Results saved to: $RESULT_DIR/attack_sparse_B_result.pkl"
