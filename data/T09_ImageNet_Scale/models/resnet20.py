...
class ResNet(nn.Module):
    ...
    Architecture:
    - Initial conv: 3x3, stride=1, padding=1 (no maxpool for 32x32)
    - 3 stages with feature depths [16, 32, 64]
    - 3 residual blocks per stage
    - Final FC layer to 10 classes
...
def resnet20(pretrained: bool = False, sparsity_type: str = None, **kwargs) -> ResNet:
    """
