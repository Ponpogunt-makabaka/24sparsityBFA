...
if __name__ == "__main__":
	...
	for it in range(n_iter):
		...
		# print global best flip and int8 value before/after candidate flip
		...
		print(f"Global best flip: module={global_max['module_name']} target={global_max['target_name']} index={global_max['multi_idx']} delta={global_max['delta']:+.6f}")
